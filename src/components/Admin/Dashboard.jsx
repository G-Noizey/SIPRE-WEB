          ...
          <ul className="nav flex-column">
            ...
            <li className="nav-item">
              <Link
                ...
                style={{ borderLeft: isDivisionHover ? '6px solid #2D7541' : '#2D7541', backgroundColor: isDivisionHover ? '#f4f4f4' : 'transparent', paddingLeft: '16px' }}
              >
            ...
            <li className="nav-item">
              <Link
                ...
                style={{ borderLeft: isTrabajadoresHover ? '6px solid #2D7541' : '#2D7541', backgroundColor: isTrabajadoresHover ? '#f4f4f4' : 'transparent', paddingLeft: '16px' }}
              >
            ...
            <li className="nav-item">
              <Link className="nav-link d-flex align-items-center"
                ...
                style={{ borderLeft: isAdministradoresHover ? '6px solid #2D7541' : '#2D7541', backgroundColor: isAdministradoresHover ? '#f4f4f4' : 'transparent', paddingLeft: '16px' }}
              >
            ...
            <li className="nav-item">
              <Link className="nav-link d-flex align-items-center"
                ...
                style={{ borderLeft: isReporteHover ? '6px solid #2D7541' : '#2D7541', backgroundColor: isReporteHover ? '#f4f4f4' : 'transparent', paddingLeft: '16px' }}
              >
